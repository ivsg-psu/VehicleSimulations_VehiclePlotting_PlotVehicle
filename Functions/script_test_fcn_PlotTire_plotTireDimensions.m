% script_test_fcn_PlotTire_plotTireDimensions.m
% tests fcn_PlotTire_plotTireDimensions.m
...
close all;
fprintf(1,'Figure: 8XXXXXX: FAST mode cases - nothing to do since this is a plotting function\n');
